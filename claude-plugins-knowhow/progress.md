...
- **PRM-LFD definition authority**: The taxonomy pre-decision definition ("active verbs + concrete outcome") overrides `checklists.md §Skill §1` ("states both 'what' and 'when'") for this item. The generated checklist-items.md entry will use the taxonomy definition.
