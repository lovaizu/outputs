 ...
 */
?>
<!-- wp:group {"tagName":"section","align":"full","className":"sec-service","backgroundColor":"white","style":{"spacing":{"padding":{"top":"80px","bottom":"80px"}}},"layout":{"type":"constrained"}} -->
<section class="wp-block-group alignfull sec-service has-white-background-color has-background" style="padding-top:80px;padding-bottom:80px" id="service">
