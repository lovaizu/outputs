...
<!-- paused: 2026-05-12 — next: #12.0 checklist.mdのUX/UIエキスパートレビュー -->
...
#### 事前準備
- [ ] 12.0 — checklist.mdをUX/UIエキスパートレビュー → 正解値の正確性・網羅性を洗練
...
#### 一覧ページ（archive-works）
- [ ] 12.5 — archive-worksのデザインカンプ画像照合 → 差分リスト作成
- [ ] 12.6 — 差分リストをユーザーに提示・確認
- [ ] 12.7 — 確認済み差分を全件修正
- [ ] 12.8 — 修正後スクリーンショット撮影 → 再照合 → 完全一致を確認

#### 詳細ページ（single-works）
- [ ] 12.9 — single-worksのデザインカンプ画像照合 → 差分リスト作成
- [ ] 12.10 — 差分リストをユーザーに提示・確認
- [ ] 12.11 — 確認済み差分を全件修正
- [ ] 12.12 — 修正後スクリーンショット撮影 → 再照合 → 完全一致を確認
