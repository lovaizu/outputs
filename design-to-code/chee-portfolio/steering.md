...
##### 12.3 — sec02 Works
- [x] ステップ1: チェックリスト作成
- [x] ステップ2: エキスパートレビュー（sec-titleフォント修正指摘 → グローバル修正済み）
- [x] ステップ3: 実装修正（sec-title: roboto-condensed + letter-spacing: 0.15em）
- [ ] ステップ4: Playwright検証 + エキスパート最終確認

##### 12.4 — sec03 Voice
- [x] ステップ1: チェックリスト作成
- [x] ステップ2: エキスパートレビュー（グローバル修正のみ — PASS）
- [x] ステップ3: 実装修正（グローバル修正で対応済み）
- [ ] ステップ4: Playwright検証 + エキスパート最終確認

##### 12.5 — sec04 Service
- [x] ステップ1: チェックリスト作成
- [x] ステップ2: エキスパートレビュー（タイトル色 text-secondary→text-primary 指摘）
- [x] ステップ3: 実装修正（タイトル色統一 + グローバルフォント修正）
- [ ] ステップ4: Playwright検証 + エキスパート最終確認
...
##### 12.8 — sec08 Contact
- [x] ステップ1: チェックリスト作成
- [x] ステップ2: エキスパートレビュー（リード文2行目欠落 指摘）
- [x] ステップ3: 実装修正（2行目追加 + 黄色ボックス固定高さ除去）
- [ ] ステップ4: Playwright検証 + エキスパート最終確認
...
- **Current state: Task 12.1〜12.9 ステップ1-3完了。全9セクションのチェックリスト作成・レビュー・実装修正済み。ステップ4（Playwright検証）はDocker起動後に実施。一覧・詳細ページのカンプは各ページ着手直前にユーザーから受領する。**
