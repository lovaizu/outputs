...
#### 事前準備
- [ ] 12.0 — checklist.mdをUX/UIデザインエキスパートがデザインカンプ画像+Figma JSONを精読してレビュー → 指摘なくなるまで繰り返し洗練（デザインカンプ完全一致に必要な全項目を正確に網羅すること）

#### トップページ（sec01〜sec08）
- [ ] 12.1 — Playwrightでスクリーンショット撮影 → checklist.mdで採点 → ❌項目をユーザーに提示・確認
- [ ] 12.2 — 確認済み❌項目を全件修正
- [ ] 12.3 — 再スクリーンショット → checklist.md再採点 → 全項目✅を確認
