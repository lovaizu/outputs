...
<!-- paused: 2026-05-12 — next: #12.10 ユーザーFB受付→修正 -->
...
#### 一覧ページ（archive-works）
- [x] 12.4 — Playwrightでスクリーンショット撮影 → checklist.mdで採点 → ❌項目をユーザーに提示・確認
- [x] 12.5 — 確認済み❌項目を全件修正
- [x] 12.6 — 再スクリーンショット → checklist.md再採点 → 全項目✅を確認

#### 詳細ページ（single-works）
- [x] 12.7 — Playwrightでスクリーンショット撮影 → checklist.mdで採点 → ❌項目をユーザーに提示・確認
- [x] 12.8 — 確認済み❌項目を全件修正（D-T5制作ツール500・D-T6本文18px・D-I1詳細画像4枚）
- [x] 12.9 — 再スクリーンショット → checklist.md再採点 → 全項目✅を確認（22/22）

#### ユーザーFBラウンド（全ページ横断）
- [ ] 12.10 — ユーザーのFBを受けて全件修正 → 指摘がなくなるまで繰り返す
