...
5.3 A finding is escalated when it involves a tradeoff or judgment the rules do not determine. Escalation requires the user to state a specific direction: accept, fix, or reject. A non-committal response does not constitute a stated direction.
