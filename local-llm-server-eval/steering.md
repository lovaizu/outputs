...
<!-- paused: 2026-05-10 — next: #2 setup vllm-mlx をインストールし Qwen3.5-27B を起動する -->

- [x] #1: research 各サーバーの仕様・CC接続方法・計測アーキテクチャを設計する（design.md）
- [ ] #2: setup vllm-mlx をインストールし Qwen3.5-27B を起動する（Claude が実行）
- [ ] #3: verify vllm-mlx の計測手順（/metrics・TTFT・usage）が実際に動くか確認し、動かなければ修正する
